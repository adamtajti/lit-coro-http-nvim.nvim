...
do
	local data = require("lit-coro-http-nvim.secure-socket.root_ca")
...
return function(options)
	local ctx = openssl.ssl.ctx_new(options.protocol or DEFAULT_SECUREPROTOCOL, options.ciphers or DEFAULT_CIPHERS)
	...
	ctx:options(bit.bor(openssl.ssl.no_sslv2, openssl.ssl.no_sslv3, openssl.ssl.no_compression))
